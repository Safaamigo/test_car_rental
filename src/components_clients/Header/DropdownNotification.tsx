    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative hidden sm:block">
      <li>
        <Link
          ...
          href="#"
          className="border-stroke bg-gray-2 text-dark dark:border-dark-4 dark:bg-dark-3 relative flex size-12 items-center justify-center rounded-full border hover:text-primary dark:text-white dark:hover:text-white"
        >
